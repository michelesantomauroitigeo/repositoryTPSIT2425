...
function Abilita(pulsante) {
    let rigaSelezionata = pulsante.closest("tr");
    rigaSelezionata.dataset.previousColor = rigaSelezionata.style.backgroundColor; // Salva il colore precedente
    rigaSelezionata.style.backgroundColor = "#c8e6c9"; // Verde chiaro per indicare abilitazione
}

function Disabilita(pulsante) {
    let rigaSelezionata = pulsante.closest("tr");
    rigaSelezionata.dataset.previousColor = rigaSelezionata.style.backgroundColor; // Salva il colore precedente
    rigaSelezionata.style.backgroundColor = "#ffcdd2"; // Rosso chiaro per indicare disabilitazione
